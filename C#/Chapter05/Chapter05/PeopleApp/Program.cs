...
namespace PeopleApp
{
 ...
 var isiah = new Person
 {
 Name = "Isiah Middleton",
 DateOfBirth = new DateTime(1999, 02, 03)
 };
 WriteLine(
 format: "{0} was born on {1:dd MMM yy}",
 arg0: isiah.Name,
 arg1: isiah.DateOfBirth);
 ...
 isiah.Children.Add(new Person { Name = "Aiden" });
 isiah.Children.Add(new Person { Name = "Sophia" });
 WriteLine($"{isiah.Name} has {isiah.Children.Count} children:");
 for (int child = 0; child < isiah.Children.Count; child++)
 {
 WriteLine($" {isiah.Children[child].Name}");
 }
 // Say hello to "Isiah"
 WriteLine(isiah.SayHello());
